...
Axioma viene del griego axioma que significa ``Lo que parece justo'' o sea lo evidente, que viene del griego "axioein``
...
Es la distancia del mismo con respecto al cero en la recta númerica.
Su valor de cualquier número siempre es positivo.
No Negatividad:
Establece que el valor absoluto de un número nunca puede ser negativo.
$| 2 | = -2$ incorrecto
Sus propiedades fundamentales son:
Definición positiva:
Si el valor del módulo de un número real "2" es "0", entonces el valor absoluto de "2" es 0 y vice-versa.
$| 2 | = 0 2 = 0$
Propiedad Multiplicativa:
Significa que un módulo de un producto de dos números es siempre igual al producto de los módulos de ambos números tomados por separado.
l 2 + 4 l = l 2 l l 4 l
Propiedad Aditiva:
Establece que el módulo del valor de la suma de dos números es siempre igual a la suma por separado del módulo de ambos números.
l 2 + 4 l = l 2 l + l 4 l
Simetría:
...
desigualdades lineales puede haber varias soluciones para una variable que satisfaga la desigualdad correspondiente.
...
4. Si x < y e z < a, entonces x + z < y + a. Se dice que las desigualdades en la misma dirección
se pueden resumir. 5. Si x < y e ambos x e y son del mismo signo, entonces > . La dirección de la desigualdad
...
Paso 2: Ahora divida ambos lados con . De acuerdo con la regla 3, las direcciones de las desigualdades cambiarán,
es decir
...
$x_1 = -1$ y $x_2 = 5/4$
Obtenemos los 3 intervalosEvaluamos un elemento de cada intervalo para identificar cuales hacen verdadera a la desigualdad
...
e y es la salida de la función\cite{cd1}
...
Ejemplo: si a la función f(x) = x2 se le dan los valores x = {1,2,3,...} entonces el rango será {1,4,9,...} \cite{cd4}
